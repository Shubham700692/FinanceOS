...
export default function Login() {
  ...
  const fillDemo = (role) => {
    const d = { admin: { email: 'admin@financeos.dev', password: 'Admin@123' }, analyst: { email: 'analyst@financeos.dev', password: 'Analyst@123' }, viewer: { email: 'viewer@financeos.dev', password: 'Viewer@123' } }
    setForm(d[role])
  }
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #1e1b4b 0%, #1e293b 60%, #0f172a 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
          <div style={{ padding: '0.75rem', background: '#4f46e5', borderRadius: '1rem', boxShadow: '0 0 20px rgb(99 102 241 / 0.4)', display: 'flex' }}>
